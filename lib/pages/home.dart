                        ...
                        Column(children: [
                          Container(
                            width: MediaQuery.of(context).size.width/2,
                              child: Text("Salad Đậu Gà Địa Trung Hải", style: AppWidget.semiBooldTextFeildStyle(),)),
                          SizedBox(height: 5.0,),
                          Container(
                              width: MediaQuery.of(context).size.width/2,
                              child: Text("Phô mai dê", style: AppWidget.LightTextFeildStyle(),)),
                          SizedBox(height: 5.0,),
                          Container(
                              width: MediaQuery.of(context).size.width/2,
                              child: Text("55000 VNĐ", style: AppWidget.semiBooldTextFeildStyle(),)),
                        ],)
                      ],
                    ),
                  ),
